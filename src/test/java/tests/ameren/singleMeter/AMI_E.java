package tests.ameren.singleMeter;
...
import tests.ameren.base.BaseTest;
...
public class AMI_E extends BaseTest {
    String token= "";
    private static Logger logger = LoggerFactory.getLogger(AMI_E.class);
    SparkSession spark;
